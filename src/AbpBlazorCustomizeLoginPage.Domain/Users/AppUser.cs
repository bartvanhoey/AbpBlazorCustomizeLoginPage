...
namespace AbpBlazorCustomizeLoginPage.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpBlazorCustomizeLoginPageDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpBlazorCustomizeLoginPageEfCoreEntityExtensionMappings to extend the IdentityUser entity
